...
import time
import sys
sys.path.append("/home/v-yali6/workspace_yal/rldp/Trial/inception/inception")
import time
import numpy as np
...
total_loss = _tower_loss(images=images, labels=labels, num_classes=1000 + 1, scope=None, reuse_variables=None)
...
for i in range(100):
    sess.run(cur_op)
Train_writer = tf.summary.FileWriter('/tmp/inception_train', sess.graph)
